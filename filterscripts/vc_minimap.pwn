...
#define MINIMAP_TEXTDRAW_POS_X 559.000000
#define MINIMAP_TEXTDRAW_POS_Y 6.651843
#define MINIMAP_TEXTDRAW_SIZE_X 75.0
#define MINIMAP_TEXTDRAW_SIZE_Y 90.0
...
UpdateVcMinimapPlayerLocation(playerid)
{
	...
	if(area > 0)
	{
		...
		PlayerTextDrawColor(playerid, pVcMinimapTextdraws[playerid][2], 0xCCCEECCFF);
