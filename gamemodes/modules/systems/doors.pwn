                ...
                switch(listitem){
                    ...
                    case 2: {
                        if(doorsInfo[index][doorType] != DOOR_TYPE_PHYSICAL){
                            ...
                            loadDoor(index);
                            editDoor[playerid] = -1;
                            ShowTDN_OOC(playerid, "Editaste la puerta de salida.");
                        }else {
...
createDoor(playerid, DOOR_TYPE, characterIDD){
...
loadDoor(index){
    if(doorsInfo[index][doorType] == DOOR_TYPE_PHYSICAL){
        ...
        doorsInfo[index][labelExit] = CreateDynamic3DTextLabel(""GREY"Pulsa "ORANGE"H"GREY" para salir", 0xFFFFFFFF, doorsInfo[index][enterCoords][0], doorsInfo[index][enterCoords][1], doorsInfo[index][enterCoords][2] + 0.5, 5, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, doorsInfo[index][exitVw]);
    }
...
forward onCreateDoor(playerid, index);
public onCreateDoor(playerid, index){
