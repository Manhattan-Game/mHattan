...
{	
	...
	velocimetroT[0] = TextDrawCreate(514.333374, 337.933532, "mdl-2001:logo_velo");
	TextDrawLetterSize(velocimetroT[0], 0.000000, 0.000000);
	TextDrawTextSize(velocimetroT[0], 148.000000, 138.000000);
	...
	velocimetroT[1] = TextDrawCreate(528.333068, 377.081481, "box");
	TextDrawLetterSize(velocimetroT[1], 0.000000, 7.199998);
	TextDrawTextSize(velocimetroT[1], 541.000000, 0.000000);
	TextDrawAlignment(velocimetroT[1], 1);
	TextDrawColor(velocimetroT[1], -1);
	TextDrawUseBox(velocimetroT[1], 1);
	TextDrawBoxColor(velocimetroT[1], 252645300);
	TextDrawSetShadow(velocimetroT[1], 0);
	TextDrawSetOutline(velocimetroT[1], 0);
	TextDrawBackgroundColor(velocimetroT[1], 255);
	TextDrawFont(velocimetroT[1], 1);
...
hook OnGameModeExit()
{
	...
	{
		guardarVehiculo(vehInfo[d][v_id]);
	}
}
hook OnPlayerConnect(playerid)
{
	velocimetroTT[playerid][0] = CreatePlayerTextDraw(playerid, 561.333312, 382.474029, "128");
	...
	PlayerTextDrawColor(playerid, velocimetroTT[playerid][0], -2139062017);
	...
	velocimetroTT[playerid][1] = CreatePlayerTextDraw(playerid, 615.333312, 384.548095, "3");
	PlayerTextDrawLetterSize(playerid, velocimetroTT[playerid][1], 0.365666, 1.326222);
	PlayerTextDrawAlignment(playerid, velocimetroTT[playerid][1], 1);
	PlayerTextDrawColor(playerid, velocimetroTT[playerid][1], -2139062017);
	PlayerTextDrawSetShadow(playerid, velocimetroTT[playerid][1], 0);
	PlayerTextDrawSetOutline(playerid, velocimetroTT[playerid][1], 0);
	PlayerTextDrawBackgroundColor(playerid, velocimetroTT[playerid][1], 255);
	PlayerTextDrawFont(playerid, velocimetroTT[playerid][1], 2);
	PlayerTextDrawSetProportional(playerid, velocimetroTT[playerid][1], 1);
	PlayerTextDrawSetShadow(playerid, velocimetroTT[playerid][1], 0);

	velocimetroTT[playerid][2] = CreatePlayerTextDraw(playerid, 527.333190, 374.022216, "mdl-2001:logo_motor");
	PlayerTextDrawLetterSize(playerid, velocimetroTT[playerid][2], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, velocimetroTT[playerid][2], 14.000000, 19.000000);
	PlayerTextDrawAlignment(playerid, velocimetroTT[playerid][2], 1);
	PlayerTextDrawColor(playerid, velocimetroTT[playerid][2], -5963521);
	PlayerTextDrawSetShadow(playerid, velocimetroTT[playerid][2], 0);
	PlayerTextDrawSetOutline(playerid, velocimetroTT[playerid][2], 0);
	PlayerTextDrawBackgroundColor(playerid, velocimetroTT[playerid][2], 255);
	PlayerTextDrawFont(playerid, velocimetroTT[playerid][2], 4);
	PlayerTextDrawSetProportional(playerid, velocimetroTT[playerid][2], 0);
	PlayerTextDrawSetShadow(playerid, velocimetroTT[playerid][2], 0);
	PlayerTextDrawSetSelectable(playerid, velocimetroTT[playerid][2], true);

	velocimetroTT[playerid][3] = CreatePlayerTextDraw(playerid, 526.999755, 392.688781, "mdl-2001:logo_luces");
	PlayerTextDrawLetterSize(playerid, velocimetroTT[playerid][3], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, velocimetroTT[playerid][3], 16.000000, 17.000000);
	PlayerTextDrawAlignment(playerid, velocimetroTT[playerid][3], 1);
	PlayerTextDrawColor(playerid, velocimetroTT[playerid][3], -5963521);
	PlayerTextDrawSetShadow(playerid, velocimetroTT[playerid][3], 0);
	PlayerTextDrawSetOutline(playerid, velocimetroTT[playerid][3], 0);
	PlayerTextDrawBackgroundColor(playerid, velocimetroTT[playerid][3], 255);
	PlayerTextDrawFont(playerid, velocimetroTT[playerid][3], 4);
	PlayerTextDrawSetProportional(playerid, velocimetroTT[playerid][3], 0);
	PlayerTextDrawSetShadow(playerid, velocimetroTT[playerid][3], 0);
	PlayerTextDrawSetSelectable(playerid, velocimetroTT[playerid][3], true);

	velocimetroTT[playerid][4] = CreatePlayerTextDraw(playerid, 527.999816, 407.622222, "mdl-2001:logo_capo");
	PlayerTextDrawLetterSize(playerid, velocimetroTT[playerid][4], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, velocimetroTT[playerid][4], 14.000000, 20.000000);
	PlayerTextDrawAlignment(playerid, velocimetroTT[playerid][4], 1);
	PlayerTextDrawColor(playerid, velocimetroTT[playerid][4], -5963521);
	...
	PlayerTextDrawSetShadow(playerid, velocimetroTT[playerid][4], 0);
	PlayerTextDrawSetSelectable(playerid, velocimetroTT[playerid][4], true);

	velocimetroTT[playerid][5] = CreatePlayerTextDraw(playerid, 527.999755, 421.311157, "mdl-2001:logo_baul");
	PlayerTextDrawLetterSize(playerid, velocimetroTT[playerid][5], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, velocimetroTT[playerid][5], 13.000000, 22.000000);
	PlayerTextDrawAlignment(playerid, velocimetroTT[playerid][5], 1);
	PlayerTextDrawColor(playerid, velocimetroTT[playerid][5], -5963521);
